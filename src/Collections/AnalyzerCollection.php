 ...
 */
class AnalyzerCollection implements Countable, IteratorAggregate
{
    ...
    public function indexOf(AnalyzerInterface $element): false|int
    {
    ...
    public function add(AnalyzerInterface $item): void
    {
        $this->innerCollection->add($item);
    }

    public function remove(AnalyzerInterface $item): void
    {
    ...
    public function contains(AnalyzerInterface $item): bool
    {
    ...
    public function first(Closure|null $callback = null): AnalyzerInterface|null
    {
    ...
    private static function assertArray(array $items): void
    {
        foreach ($items as $item) {
            if (false === ($item instanceof AnalyzerInterface)) {
                throw new InvalidArgumentException('All items must be of type: ' . AnalyzerInterface::class);
            }
        }
    }
}
