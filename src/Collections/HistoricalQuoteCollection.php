...
class HistoricalQuoteCollection implements Countable, IteratorAggregate
{
    ...
    public function indexOf(HistoricalQuoteInterface $element): false|int
    {
    ...
    public function add(HistoricalQuoteInterface $item): void
    {
        $this->innerCollection->add($item);
    }

    public function remove(HistoricalQuoteInterface $item): void
    {
    ...
    public function contains(HistoricalQuoteInterface $item): bool
    {
    ...
    public function first(Closure|null $callback = null): HistoricalQuoteInterface|null
    {
    ...
    private static function assertArray(array $items): void
    {
        foreach ($items as $item) {
            if (false === ($item instanceof HistoricalQuoteInterface)) {
                throw new InvalidArgumentException('All items must be of type: ' . HistoricalQuoteInterface::class);
            }
        }
    }
}
